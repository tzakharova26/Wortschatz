...
def commands_help(lang: str = DEFAULT_LANGUAGE) -> str:
    ...
    if lang == "ru":
        return (
            ...
            "/verbs [N] [тег] — повторить формы глаголов с карточкой перед вопросами\n"
            "/learn [N] [тег] — выучить новые слова или слова после Blackout\n"
            "/stats — показать статистику\n"
            "/today — список слов, выученных и повторенных сегодня\n"
    ...
    return (
        ...
        "/verbs [N] [tag] — revise verb forms after seeing verb cards\n"
        "/learn [N] [tag] — learn new (or Blackout-flagged) words; graduates them into /quiz\n"
        "/stats — show learning statistics\n"
        "/today — show words learned and repeated today\n"
...
def learn_start_message(n: int, lang: str = DEFAULT_LANGUAGE) -> str:
    ...
    if lang == "ru":
        return (
            ...
            "форма в примере для прилагательных, формы для глаголов.\n"
    ...
    return (
        ...
        "  + article and plural (nouns), adjective form in context, verb forms.\n"
...
def add_format_message(lang: str = DEFAULT_LANGUAGE) -> str:
    ...
    if lang == "ru":
        return (
            ...
            "Без мн. числа: <code>n das Geld - money</code>\n"
            "Или:    <code>n | die | Katze | Katzen | small cat</code>\n\n"
            "<code>v infinitive translation</code>  (правильный глагол)\n"
            "Пример: <code>v machen to do</code>\n\n"
            "Нестандартные формы можно добавить короткими ключами: "
            "<code>p=Partizip II</code>, <code>pr=Präteritum</code>, "
            "<code>pr_du=Präteritum du</code>, <code>du=...</code>, <code>er=...</code>.\n"
            "Пример: <code>v | sein | p=ist gewesen | pr_ich=war | pr_du=warst | "
            "pr_er=war | to be</code>\n\n"
            ...
            "<code>phr | expression | translation</code>  (фразы и устойчивые сочетания)\n"
            "Пример: <code>phr | sich Mühe geben | to make an effort</code>\n\n"
    ...
    return (
        ...
        "No plural: <code>n das Geld - money</code>\n"
        "Or:      <code>n | die | Katze | Katzen | small cat</code>\n\n"
        "<code>v infinitive translation</code>  (regular)\n"
        "Example: <code>v machen to do</code>\n\n"
        "Add non-standard forms with short keys: <code>p=Partizip II</code>, "
        "<code>pr=Präteritum</code>, <code>pr_du=Präteritum du</code>, "
        "<code>du=...</code>, <code>er=...</code>.\n"
        "Example: <code>v | sein | p=ist gewesen | pr_ich=war | pr_du=warst | "
        "pr_er=war | to be</code>\n\n"
        "<code>adj word translation</code>\n"
        ...
        "<code>phr | expression | translation</code>  (phrases and collocations)\n"
        "Example: <code>phr | sich Mühe geben | to make an effort</code>\n\n"
...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "practice_help": (
            ...
            "Article, Plural, adjective-in-context, and verb-form questions when they apply.\n\n"
            "<b>/verbs [N] [tag]</b> — focused verb revision. First it shows cards with "
            "regular generated forms and stored irregular forms, then asks typed form "
            "questions. When possible, at least half of the questions use stored "
            "irregular forms.\n\n"
        ),
    },
    "ru": {
        ...
        "practice_help": (
            ...
            "множественное число, формы прилагательных в контексте и формы глаголов.\n\n"
            "<b>/verbs [N] [тег]</b> — отдельная тренировка глаголов: сначала карточки "
            "с регулярными сгенерированными формами и сохраненными нестандартными "
            "формами, потом вопросы на ввод. Если возможно, минимум половина вопросов "
            "будет по сохраненным нестандартным формам.\n\n"
        ),
    },
}
